...
/** Common autosuggest configuration shared by three-word-address search providers. */
abstract class AutosuggestSearchConfig {
    ...
    /** Builds a [W3WAutosuggestOptions.Builder] pre-populated with the common config fields. */
    internal fun buildBaseOptions(): W3WAutosuggestOptions.Builder =
